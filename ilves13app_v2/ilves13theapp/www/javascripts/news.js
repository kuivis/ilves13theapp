...
var TITLE = "Uutiset";
//RSS url
var RSS = "http://ilves.hp.partio.fi/category/uutiset/feed/";
//Stores entries
var entries = [];
var selectedEntry = "";
...
function renderEntries(entries) {
    var s = '<li data-role="list-divider" role="heading">Mit&auml; uutta Ilveksell&auml;?</li>';
...
$("#news_section").live("pageinit", function() {
	//Set the title
	$("h1", this).text(TITLE);
	google.load("feeds", "1",{callback:initialize});
});

$("#news_section").live("pagebeforeshow", function(event,data) {
